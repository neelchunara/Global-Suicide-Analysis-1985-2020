...
// Group data by year and calculate sum suicide rates
function groupDataByYear(data) {
    ...
    data.forEach(entry => {
        ...
        else {groupedData[entry.year] += entry.sucides_100k_pop};
    });
